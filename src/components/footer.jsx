      ...
      <div className="row g-5 mb-5">
        <div className="col-lg-4">
          <div className="mb-4 footer-logo-wrap">
            <a href="#" className="footer-logo">Possible Decor<span>.</span></a>
          </div>
          <p className="mb-4">Transforming spaces with elegance and creativity—where style meets comfort, and your vision becomes reality with our expert touch.</p>
        ...
        <div className="row pt-4">
          <div className="col-lg-6">
            <p className="mb-2 text-center text-lg-start">
              ...
              Designed with love by <a href="https://untree.co">Untree.co</a> Distributed By <a href="https://themewagon.com">ThemeWagon</a>   License information: https://untree.co/license/
            </p>
          </div>
