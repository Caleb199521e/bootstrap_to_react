    ...
    <div className="container">
        <div className="sidebar">
            ...
            <ul className="category-list">
                ...
                <li><a href="/decorAccessories.html">Decor Accessories</a></li>
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-md-4 col-lg-3 mb-5">
                            <a className="product-item" href="#">
                                <img src="./assets/images/Product/Marble Sheets/1.jpg" className="img-fluid product-thumbnail" alt="Marble Sheets 1" />
                                <h3 className="product-title">Marble Sheets</h3>
                        ...
                        <div className="col-12 col-md-4 col-lg-3 mb-5">
                            <a className="product-item" href="#">
                                <img src="./assets/images/Product/Marble Sheets/2.jpeg" className="img-fluid product-thumbnail" alt="Marble Sheets 2" />
                                <h3 className="product-title">Marble Sheets</h3>
                                <strong className="product-price">GH₵ 400.00</strong>
                                <span className="icon-cross">
                                    <img src="./assets/images/cross.svg" className="img-fluid" alt="Close Icon" />
                        ...
                        <div className="col-12 col-md-4 col-lg-3 mb-5">
                            <a className="product-item" href="#">
                                <div className="product-img">
                                    <img src="./assets/images/Product/Marble Sheets/3.jpeg" className="img-fluid product-thumbnail" alt="Marble Sheets 3" />
                                </div>
                                <h3 className="product-title">Marble Sheets</h3>
                        ...
                        <div className="col-12 col-md-4 col-lg-3 mb-7">
                            <a className="product-item" href="#">
                                <img src="./assets/images/Product/Marble Sheets/4.jpeg" className="img-fluid product-thumbnail" alt="Marble Sheet 4" />
                                <h3 className="product-title">Marble Sheet</h3>
                                <strong className="product-price">GH₵ 200.00</strong>
                                <span className="icon-cross">
                                    <img src="./assets/images/cross.svg" className="img-fluid" alt="Close Icon" />
                                </span>
                        ...
                        <div className="col-12 col-md-4 col-lg-3 mb-5">
                            <a className="product-item" href="#">
                                <img src="./assets/images/Product/Marble Sheets/5.jpeg" className="img-fluid product-thumbnail" alt="Marble Sheets 5" />
                                <h3 className="product-title">Marble Sheets</h3>
                                <strong className="product-price">GH₵ 200.00</strong>
                                <span className="icon-cross">
                                    <img src="./assets/images/cross.svg" className="img-fluid" alt="Close Icon" />
                        ...
                        <div className="col-12 col-md-4 col-lg-3 mb-5">
                            <a className="product-item" href="#">
                                <img src="./assets/images/Product/Marble Sheets/6.jpg" className="img-fluid product-thumbnail" alt="Marble Sheets 6" />
                                <h3 className="product-title">Marble Sheets</h3>
                                <strong className="product-price">GH₵ 400.00</strong>
                                <span className="icon-cross">
                                    <img src="./assets/images/cross.svg" className="img-fluid" alt="Close Icon" />
                        ...
                        <div className="col-12 col-md-4 col-lg-3 mb-5">
                            <a className="product-item" href="#">
                                <img src="./assets/images/Product/Marble Sheets/7.jpg" className="img-fluid product-thumbnail" alt="Marble Sheets 7" />
                                <h3 className="product-title">Marble Sheets</h3>
                                <strong className="product-price">GH₵ 200.00</strong>
                                <span className="icon-cross">
                                    <img src="./assets/images/cross.svg" className="img-fluid" alt="Close Icon" />
                        ...
                        <div className="col-12 col-md-4 col-lg-3 mb-5">
                            <a className="product-item" href="#">
                                <img src="./assets/images/Product/Marble Sheets/7.jpg" className="img-fluid product-thumbnail" alt="Marble Sheets 8" />
                                <h3 className="product-title">Marble Sheets</h3>
                                <strong className="product-price">GH₵ 200.00</strong>
                                <span className="icon-cross">
                                    <img src="./assets/images/cross.svg" className="img-fluid" alt="Close Icon" />
